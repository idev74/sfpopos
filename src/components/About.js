...
export default function About() {
  return (
    <div class="about">
      ...
      <img src="https://images.unsplash.com/photo-1506146332389-18140dc7b2fb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fHNhbiUyMGZyYW5jaXNjb3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="golden-gate"/>
      </div>
      <h1>About SFPOPOS</h1>
